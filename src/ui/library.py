...
class EnhancedLibrarySection:
    ...
    def apply_filters(self, games):
        ...
        return LibraryFilterSort.apply_filters(
            games=games,
            selected_platform=selected_platform,
            search_text=self.search_text,
            show_downloaded_only=self.show_downloaded_only
        )
    ...
    def sort_games_consistently(self, games):
        ...
        return LibraryFilterSort.sort_games_consistently(games, sort_downloaded_first=sort_downloaded_first)
    ...
    def on_save_history_clicked(self, button):
        ...
        dialog = HistoryDialog(self.parent, self)
        dialog.show_state_history(game, name)
    ...
    def on_save_file_history_clicked(self, button):
        ...
        from ui.history_dialog import HistoryDialog
        dialog = HistoryDialog(self.parent, self)
        dialog.show_save_file_history(game, name)
    def auto_expand_platforms_with_results(self, filtered_games):
        ...
        platforms_with_results = LibraryFilterSort.get_platforms_with_results(filtered_games)
